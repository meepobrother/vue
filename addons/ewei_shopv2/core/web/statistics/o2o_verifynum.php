...
class O2o_verifynum_EweiShopV2Page extends WebPage 
{
	public function main() 
	{
		...
		if ($_GPC['export'] == 1) 
		{
			m('excel')->export($list, array( 'title' => '会员消费排行报告-' . date('Y-m-d-H-i', time()), 'columns' => array( array('title' => '门店id', 'field' => 'id', 'width' => 12), array('title' => '门店名称', 'field' => 'storename', 'width' => 12), array('title' => '核销订单数量', 'field' => 'num', 'width' => 12) ) ));
