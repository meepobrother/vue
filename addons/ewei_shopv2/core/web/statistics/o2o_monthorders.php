...
class O2o_monthorders_EweiShopV2Page extends WebPage 
{
	public function main() 
	{
		...
		if ($_GPC['export'] == 1) 
		{
			m('excel')->export($list, array( 'title' => '会员消费排行报告-' . date('Y-m-d-H-i', time()), 'columns' => array( array('title' => '门店id', 'field' => 'id', 'width' => 12), array('title' => '门店名称', 'field' => 'storename', 'width' => 12), array('title' => '订单数量', 'field' => 'num', 'width' => 12), array('title' => '订单总销售额', 'field' => 'num3', 'width' => 12), array('title' => '订单平均单价', 'field' => 'num2', 'width' => 12) ) ));
