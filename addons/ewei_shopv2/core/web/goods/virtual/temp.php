...
class Temp_EweiShopV2Page extends ComWebPage 
{
	...
	protected function post() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			$insert = array('uniacid' => $_W['uniacid'], 'cate' => intval($_GPC['cate']), 'title' => trim($_GPC['tp_title']), 'fields' => iserializer($data), 'linktext' => trim($_GPC['tp_linktext']), 'linkurl' => trim($_GPC['tp_linkurl']));
			if (empty($id)) 
			{
