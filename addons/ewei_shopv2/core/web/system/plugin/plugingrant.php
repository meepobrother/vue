...
class Plugingrant_EweiShopV2Page extends SystemPage 
{
	...
	protected function post() 
	{
		...
		if ($_W['ispost']) 
		{
			$acid = pdo_fetch('SELECT acid,uniacid FROM ' . tablename('account_wechats') . ' WHERE acid=:acid limit 1', array(':acid' => intval($_GPC['acid'])));
