...
class Export_EweiShopV2Page extends WebPage 
{
	...
	public function main() 
	{
		...
		if ($_GPC['export'] == 1) 
		{
			...
			if ($address2index != -1) 
			{
				array_splice($columns, $address2index + 1, 0, array( array('title' => '市', 'field' => 'address_city', 'width' => 12), array('title' => '区', 'field' => 'address_area', 'width' => 12), array('title' => '街道', 'field' => 'address_street', 'width' => 12), array('title' => '地址', 'field' => 'address_address', 'width' => 24) ));
			}
			$goodsindex = $this->field_index($columns, 'goods_title');
			if ($goodsindex != -1) 
			{
				array_splice($columns, $goodsindex + 1, 0, array( array('title' => '商品短标题', 'field' => 'goods_shorttitle', 'width' => 12), array('title' => '商品编码', 'field' => 'goods_goodssn', 'width' => 12), array('title' => '商品条码', 'field' => 'goods_productsn', 'width' => 12), array('title' => '商品规格', 'field' => 'goods_optiontitle', 'width' => 12), array('title' => '商品数量', 'field' => 'goods_total', 'width' => 12), array('title' => '商品单价(折扣前)', 'field' => 'goods_price1', 'width' => 12), array('title' => '商品单价(折扣后)', 'field' => 'goods_price2', 'width' => 12), array('title' => '商品价格(折扣前)', 'field' => 'goods_rprice1', 'width' => 12), array('title' => '商品价格(折扣后)', 'field' => 'goods_rprice2', 'width' => 12) ));
			}
